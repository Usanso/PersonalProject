...
public class PlayerItemController : MonoBehaviour
{
    ...
    // 상태 변수
    [SerializeField] private bool isActive = true; // 플레이어가 조작 중인지
    ...
    {
        TimeManager.Instance.OnTimeUpdated += TimeHandle; // 이벤트 구독
    }

    private void OnDisable()
    {
        TimeManager.Instance.OnTimeUpdated -= TimeHandle; // 이벤트 구독 해제
    }
